...
extension Category {
    ...
    static let entertainmet = Category(id: 3, name: "Entertainment", icon: .film)
    ...
    static let moviesAndDVDs = Category(id: 301, name: "Movies & DVDs", icon: .mobile_alt, mainCategoryId: 3)
    ...
    static let restaurents = Category(id: 502, name: "Restaurents", icon: .utensils, mainCategoryId: 5)
